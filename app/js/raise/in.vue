        ...
        <div :class="$style.item" v-for="item in items" :key="item.img">
            ...
            <section :class="$style.list">
                <div :class="$style.product"  v-for="product in item.list" :key="product.img">
                    ...
                    <label v-if="product.wordKey">{{ product.wordKey }}</label>
                </div>
            </section>
        </div>
    </section>
...
<script>
    ...
    export default {
        ...
        data() {
            return{
                items:  [{
                catory: "https://img12.360buyimg.com/jrpmobile/jfs/t3406/210/2247820735/50952/86016eea/5846d8e7N20446dbd.png?width=750&height=200",
                list: [{
                ...
                catory: "https://img12.360buyimg.com/jrpmobile/jfs/t3739/82/2244582797/54399/746c7d79/5846a953N66b67d05.png?width=750&height=200",
                list: [{
                ...
                catory: "https://img12.360buyimg.com/jrpmobile/jfs/t3214/113/4408032436/61548/ce316eef/5846d310Ne93f00c9.png?width=750&height=200",
                list: [{
