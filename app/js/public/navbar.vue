        ...
        <ul :class="$style.content">
            ...
            <li>
                <router-link :to="{ name: 'raise'}">
                    <img src="https://img12.360buyimg.com/jrpmobile/jfs/t3604/98/635506544/2317/443d3a51/580f240aNbee3dcc4.png?width=66&height=66" alt="">
                    <p>众筹</p>
                </router-link>
            </li>
            <li>
                <router-link :to="{ name: 'down'}">
